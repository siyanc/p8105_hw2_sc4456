...
NYC_transit_data_modified %>% 
  filter(vending == "NO") 
NYC_novending_but_allowentry = 
  NYC_novending_data %>% 
filter(entry == "TRUE")
nrow(NYC_novending_but_allowentry) / nrow(NYC_novending_data)
```
* What proportion of station entrances / exits without vending allow entrance? It returns `r nrow(NYC_novending_but_allowentry) / nrow(NYC_novending_data)` station entrances/exits without vending allow entrance. 
